...
@include('bibtexbrowser.openTheses.php',__FILE__));
...
class MenuManager {
  ...
  function yearVC() {
    ...
    /** $this->displayMenu('Years', $years, $page, $this->year_size, Q_YEAR_PAGE,Q_YEAR); */
  }
...
class Dispatcher {
  ...
  function frameset() {    ?>
    ...
    <meta name="generator" content="bibtexbrowser v20130328" />
    <meta http-equiv="Content-Type" content="text/html; charset=<?php echo ENCODING ?>"/>
      <title>Open Project Topics (BSc/MSc/PhD)</title>
    </head>
    <frameset cols="15%,*">
